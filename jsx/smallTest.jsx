...
var title = mog.getMGTComponent();

// $.writeln(param[0])
// var title = mog.components[2].properties;
var te = title.properties[0].getValue()

// var pe = JSON.parse(te)
// $.writeln(pe)

title.properties[0].setValue("pedro")
title.properties[1].setValue("el listo")

// app.encoder.launchEncoder();
app.encoder.encodeSequence(
    seq,
    "C:\\Users\\s.boldu\\Desktop\\translator.mp4",
...
// title[0].setValue(param[0], 1);
// title[1].setValue(param[1], 1);
